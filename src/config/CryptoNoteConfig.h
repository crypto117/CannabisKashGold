...
const uint64_t CRYPTONOTE_PUBLIC_ADDRESS_BASE58_PREFIX       = 0x27a054;
...
const uint64_t LWMA_2_DIFFICULTY_BLOCK_INDEX_V3              = 100000;
...
const uint32_t UPGRADE_HEIGHT_V4                             = 2000; // Upgrade height for CN-Lite Variant 1 switch.
const uint32_t UPGRADE_HEIGHT_V5                             = 3000; // Upgrade height for CN-Turtle Variant 2 switch.
...
const char     CRYPTONOTE_NAME[]                             = "CannabisKashGold";
...
const int      P2P_DEFAULT_PORT                              =  8011;
const int      RPC_DEFAULT_PORT                              =  8010;
const int      SERVICE_DEFAULT_PORT                          =  8025;
...
const char     LATEST_VERSION_URL[]                          = "http://github.com/chronickash/ChronicKash.git";
const std::string LICENSE_URL                                = "https://github.com/chronickash/chronickash/blob/master/LICENSE";
const static   boost::uuids::uuid CRYPTONOTE_NETWORK         =
{
    {  0xc5, 0x06, 0x49, 0x6e, 0xf2, 0xf7, 0x47, 0x29, 0x31, 0xf4, 0x79, 0xe2, 0xe8, 0xe9, 0x73, 0x75  }
};

const char* const SEED_NODES[] = {
  "206.189.148.216:8011",//Bud
  "134.209.95.228:8011",//Smoke
};
} // CryptoNote
